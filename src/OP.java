...
public class OP extends HttpServlet {
	static char workload[]=  {'n','v','a','n','v','a','n','v','a','n','a','n','v','a','v','v','v','n','v','a','v','a','v','a','a','v'};
	static char technical[]= {'n','v','n','a','a','a','n','a','v','n','a','a','a','a','v','v','v','v','n','a','a','n','n','v','a','a'};
	static char neccessity[]={'n','n','v','a','n','a','a','v','n','n','a','a','v','v','a','a','v','v','v','n','n','v','n','v','v','n'};
	static char advance[]=   {'n','a','n','n','n','a','a','a','a','a','a','n','a','a','n','v','n','v','v','v','n','v','n','n','v','n'};
	static char class1[]=    {'B','A','B','B','B','A','B','A','B','B','A','B','A','A','A','A','A','A','A','B','B','A','B','A','A','B'};
...
if(prob_of_play >=0 && prob_of_play<=1 ){
	flag2=1;
			   ...
			   out.println("\nThe new tuple classified under \"Good\" category.Hence the course is awesome.Positive Feedback!!!");
			    }
			    else{
			    	if(flag2==0){
			  ...
			  out.println("\nThe new tuple classified under \"Bad\" category.Hence the the course is bad. Negative Feedback");
			    }

			    
			    out.println("<pre><br><br><br><br>Table of conditional probalities:<br><br><br>"
			    		+ "<b>Attribute        Good                Bad<b>"
			    		+ "<br>              Workload     "+prob[0][0]+ "      "+prob[0][1]+""
			    				+ "<br>           Technical     "+prob[1][0]+ "      "+prob[1][1]+""
			    		+"<br>                 Necessity    "+prob[2][0]+ "      "+prob[2][1]+""
			    		+"<br>               Advanced    "+prob[3][0]+ "      "+prob[3][1]+"</pre>");
